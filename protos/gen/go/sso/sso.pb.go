...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` //Auth token of the user logged
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x12, 0x70, 0x69, 0x6c, 0x69, 0x70, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73,
